...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgresql://postgres:postgres1@127.0.0.1:6432/dj?sslmode=disable",
        # default="postgres://postgres:postgres1@127.0.0.1:5432/dj",
    ),
}
...

    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "dj.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""Ivan""", "ivan@dj.binetc.site")]
...
ACCOUNT_FORMS = {"signup": "dj.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "dj.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "dj.users.forms.UserSocialSignupForm"}
